...
import com.google.android.testing.nativedriver.server.handler.DoubleClick;
import com.google.android.testing.nativedriver.server.handler.DoubleTap;
import com.google.android.testing.nativedriver.server.handler.Drag;
import com.google.android.testing.nativedriver.server.handler.LongClick;
import com.google.android.testing.nativedriver.server.handler.Scroll;
...
/**
 * Extension of the WebDriver default DriverServlet class which registers and configures the Android
 * NativeDriver (AND) for use with the WebDriver server framework.
 * 
