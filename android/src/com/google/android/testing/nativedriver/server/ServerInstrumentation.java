 ...
 * @author Theo Huang
 * 
 * merged to jetty7 with selenium 2.35
 * 
 */
public class ServerInstrumentation extends Instrumentation {
  ...
  //Is deprecated in API 13, but still works.
...
//    Window window = activitiesReporter.getActivities().current().getWindow();
...
//    window.addFlags(WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD);
  ...
  protected Handler createHandler() {
	  org.seleniumhq.jetty7.servlet.ServletContextHandler root
        = new org.seleniumhq.jetty7.servlet.ServletContextHandler(server, "/hub",
    ...
    handlers.setHandlers(
        new Handler[] {root, new DefaultHandler()});
    return handlers;
  }
