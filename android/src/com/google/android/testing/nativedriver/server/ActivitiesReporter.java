...
/**
 * Receives notification of activity events and enables manipulation of these activities through an
 * {@link Activities} object.
 * 
 * @author Matt DeVore
 */
public class ActivitiesReporter {
	...
	private class ActivitiesImpl implements Activities {
		...
		@Override
		public Map<Activity, Integer> getLiveActivities() {
