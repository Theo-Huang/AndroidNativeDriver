...
public class ViewElementFactory {
   ...
   *        {@code View}
   */
  public ViewElement<?> newViewElement(AndroidNativeDriver driver ,ElementContext context, View view) {
    for (ViewElementType viewElementType : types) {
      if (viewElementType.supportsView(view)) {
        return viewElementType.newInstance(driver,context,view);
      }
    }
