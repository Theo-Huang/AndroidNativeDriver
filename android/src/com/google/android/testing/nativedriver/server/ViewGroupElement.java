...
public class ViewGroupElement<V extends ViewGroup> extends ViewElement<V> {
  ...
  public static final ViewElementType TYPE
    ...
    public ViewElement<?> newInstance(AndroidNativeDriver driver , ElementContext context, View view) {
      return new ViewGroupElement<ViewGroup>(driver,context, (ViewGroup) view);
    }
  };
  ...
  private class ChildrenIterator extends AbstractIterator<ViewElement<?>> {
    ...
    protected ViewElement<?> computeNext() {
      ...
      return (nextView != null)
          ? context.newViewElement(driver,nextView)
          : endOfData();
    }
  }
  ...
  public ViewGroupElement(AndroidNativeDriver driver ,ElementContext context, V view) {
