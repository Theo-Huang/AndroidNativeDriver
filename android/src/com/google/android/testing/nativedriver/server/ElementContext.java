...
public class ElementContext {
   ...
   *         {@code View}
   */
  public ViewElement<? extends View> newViewElement(AndroidNativeDriver driver ,View viewToWrap) {
		return viewElementFactory.newViewElement(driver, this, viewToWrap);
	}
}
