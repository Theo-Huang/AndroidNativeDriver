...
/**
 * A {@code BySelector} which supports Android Native-specific search strategies in addition to
 * those supplied by WebDriver.
 * 
 * @author Matt DeVore
 * @author Theo Huang
 */
public class AndroidNativeBySelector extends BySelector {
	...
	public By pickFrom(String method, String selector) {
		...
		} else if (FindsAll.CURRENT_ACTIVITY.equals(method)) {
			return AndroidNativeBy.all(Boolean.valueOf(selector.toLowerCase()));
		} else {
